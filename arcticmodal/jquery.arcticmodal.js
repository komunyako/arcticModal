    ...
    var actions = {
        ...
        show: function() {
            ...
            if (D.wrap.css('overflow-y')!='hidden') {
                D.wrap.data('arcticmodalOverflow', D.wrap.css('overflow-y'));
                var w1 = D.wrap.outerWidth(true);
                D.wrap.css('overflow-y', 'hidden');
                D.wrap.css('overflow-x', 'hidden');
                var w2 = D.wrap.outerWidth(true);
                if (w2!=w1)
                    D.wrap.css('marginRight', (w2 - w1) + 'px');

                if(D.fixed)
                    $(D.fixed).css('right', (w2 - w1));
            }
        ...
        close: function() {
            if ($.isFunction(this)) {
                ...
                return this.each(function() {
                    ...
                    //не даем закрыть пока у форма заблокирована
                    ...
                    modal.transition(D.container.block, 'hide', modals.length>1 ? {type: 'none'} : D.closeEffect, function() {
                        ...
                        if (!$('.arcticmodal-container').length) {
                            if (D.wrap.data('arcticmodalOverflow'))
                                D.wrap.css('overflow-y', D.wrap.data('arcticmodalOverflow'));
                                D.wrap.css('overflow-x', 'auto');
